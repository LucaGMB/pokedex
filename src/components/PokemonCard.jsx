...
function TypeBadge({ type }) {
  return (
    <span className={styles.badge} style={{ backgroundColor: TYPE_COLORS[type] || '#888' }}>
      {type}
    </span>
  );
}

export function PokemonCard({ pokemon, isFavorite, onToggleFavorite, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <img className={styles.sprite} src={pokemon.sprite} alt={pokemon.name} loading="lazy" />
